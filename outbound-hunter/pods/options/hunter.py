"""
pods/options/hunter.py
OptionsHunter — scanning for options traders posting pain signals.
"""
...
class OptionsHunter(BaseHunter):
    """
    Niche pod for the Options Trading vertical.
    Covers both retail degens (0DTE, yolo) and income traders (wheel/theta).
    Targets r/options, r/thetagang, and X for Greeks confusion, IV crush disasters.
    Platform weights: Reddit 0.50  Twitter 0.30  LinkedIn 0.10  Facebook 0.10
    """

    POD_SLUG  = "options"
    POD_LABEL = "Options Trading"

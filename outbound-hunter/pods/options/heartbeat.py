"""
pods/options/heartbeat.py
Scheduling and status reporting for the Options Trading pod.
"""
...
def run(hunter_instance=None) -> dict:
    ...
    try:
        if hunter_instance is None:
            ...
            from hunter import OptionsHunter
            hunter = OptionsHunter(run_id=run_id)
        else:

"""
pods/swing-trading/hunter.py
SwingTradingHunter — scanning for swing traders posting pain signals.
"""
...
class SwingTradingHunter(BaseHunter):
    """
    Niche pod for the Swing Trading vertical.
    Targets position traders holding 2–14 days who post about
    failed breakouts, overnight risk, and inconsistent setups.
    Platform weights: Reddit 0.45  Twitter 0.30  LinkedIn 0.15  Facebook 0.10
    """

    POD_SLUG  = "swing-trading"
    POD_LABEL = "Swing Trading"

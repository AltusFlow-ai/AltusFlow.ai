"""
pods/altusflow-own/heartbeat.py
Scheduling and status reporting for the AltusFlow Own Prospecting pod.
"""
...
def run(hunter_instance=None) -> dict:
    ...
    try:
        if hunter_instance is None:
            ...
            from hunter import AltusFlowOwnHunter
            hunter = AltusFlowOwnHunter(run_id=run_id, user_id="ALT00")
        else:

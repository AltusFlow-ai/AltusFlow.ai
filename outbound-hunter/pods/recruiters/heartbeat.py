"""
pods/recruiters/heartbeat.py
Scheduling and status reporting for the Recruiters pod.
"""
...
def run(hunter_instance=None) -> dict:
    ...
    try:
        if hunter_instance is None:
            ...
            from hunter import RecruiterHunter
            hunter = RecruiterHunter(run_id=run_id)
        else:

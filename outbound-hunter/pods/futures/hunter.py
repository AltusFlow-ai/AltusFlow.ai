"""
pods/futures/hunter.py
FuturesHunter — scanning for futures traders posting pain signals.
"""
...
class FuturesHunter(BaseHunter):
    """
    Niche pod for the Futures Trading vertical.
    Targets ES/NQ/MNQ traders posting about prop firm failures,
    stopped-out entries, and leverage disasters.
    Platform weights: Reddit 0.50  Twitter 0.30  LinkedIn 0.10  Facebook 0.10
    """

    POD_SLUG  = "futures"
    POD_LABEL = "Futures Trading"
